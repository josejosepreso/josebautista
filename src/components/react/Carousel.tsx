        ...
        <>
            <div className="flex flex-col justify-center items-center">
                <div className="flex items-center">
                    <button
                        onClick={() => setIdx(idx => idx - 1 < 0 ? imgs.length - 1 : idx - 1)}
                        className="p-3 bg-blue-500 h-auto mx-4 font-extrabold text-white text-3xl rounded-xl hover:cursor-pointer"
                    >
                    ...
                    >
                        <div style={{ height: "100%" }} className="flex items-center justify-center relative">
                            <div
                                style={{ height: "100%", width: "100%" }}
                                className={ "bg-black opacity-50 flex items-center absolute" + ( show ? "invisible" : "invisible" )}
                            >
                            </div>
                            <img
                                style={{ maxHeight: "100%" }}
                    ...
                    <button
                        onClick={() => setIdx(idx => idx + 1 >= imgs.length ? 0 : idx + 1)}
                        className="p-3 bg-blue-500 h-auto mx-4 font-extrabold text-white text-3xl rounded-xl hover:cursor-pointer"
                    >
                ...
                <div className="flex mt-5 space-x-3">
                    {
                        ...
                        .map((_, i) => (
                            <a
                                key={ i }
                                onClick={() => setIdx( i )}
                                className={`h-4 w-4 rounded-xl border-solid border-1 border-blue-500 ${ i == idx ? "bg-blue-500" : "" } hover:cursor-pointer`}
                            >
                            </a>
                        ))
                    }
